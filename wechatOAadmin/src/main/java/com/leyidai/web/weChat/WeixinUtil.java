...
public class WeixinUtil {
	...
	public static String getOpenIdByHtmlToken(String code){
		String openid = "j1AIKMkdEiimTfPMSaman5W14rNX-vlUmLehoz7Yyos";
...
//			String access_token = rtnJson.get("access_token").toString();
//			String expires_in = rtnJson.get("expires_in").toString();
//			String refresh_token = rtnJson.get("refresh_token").toString();
//			String scope = rtnJson.get("scope").toString();
