...
public class WeChatModelUtil {
	 ...
	 * @return
	 */
	public static String pushMessage(String openId, String rtnUrl,
	 ...
	 * @return
	 */
	public static String pushFailedMessage(String openId, String rtnUrl,
			String userName, String transactType, String date, String address,
			String remark) {
	...
	public static String pushFinishMessage(String openId, String rtnUrl,
		...
		String url = modelUrl.replace("ACCESS_TOKEN",
				ConstantWeChat.ACCEESS_TOKEN);
		String templateId = "Q2tbxVCNq7kCRx17-Vsk2ed7LhAmQgzooFCu73i8X6w"; // 正式
		Map<String, Object> pushData = new HashMap<String, Object>();
		pushData.put("touser",  openId);
		pushData.put("template_id",  templateId);
		pushData.put("url", rtnUrl);
...
//		String token = "RgkQ2dmum_4tmtcqgKkL41A3Ae2bDqxI3tl1YWYS9BLz_5c1HXdwRkbOTFBp3OPUdF2jlfGguRTVKhFJkmet7hKYU9ppSp4681KS-0_VIVNnQibdT3mhSXGIAsS-Avo7AXKeAIAGDQ";
		WeChatModelUtil.pushMessage(template_id, "", "张松涛", "", "2016-05-06 08:00-09:30", "北辰区不动产登记处", "请您持身份证及业务办理所需材料在预约办理时间段内完成取号，不能办理业务请及时取消。");
	}
}
