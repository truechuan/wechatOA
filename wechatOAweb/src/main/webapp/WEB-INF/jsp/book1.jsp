...
<body id="order">
	...
	<div class="content">
		...
		<div class="btn-group">
			...
			<select name="transactOrgId"
				style="margin-left:15%;margin-top:12px;margin-bottom:12px;"
	...
	<div class="content">
		...
		<c:if test="${area eq 1035 }">
			<br />
			<span style="color:red; margin-left:13%;margin-right:13%;">二手房过户需在“产权证/合同号”处</span>
			<span style="color:red; margin-left:13%;margin-right:13%;">同时填写产权证号和协议号。</span>
			<br />
		</c:if>
		...
		<span type="text" style="width:35%; "><img id="vimg"
			title="点击更换" onclick="changeCode();" src=""><br />
		</span>
	</div>
	<div class="content">
		<c:choose>
	...
	<script>
		...
		function changeCode() {
			...
			$.get("<c:url value='/captcha'/>?t=" + Math.random(), function(
					result) {
				imgNode.src = result; // 防止浏览器缓存的问题       
			});
		}
		...
		function submitData(obj) {
			...
			$.post(url, {
				...
				"transactOrgName" : transactOrgName,
				"transactTypeId" : transactTypeIdValue,
				"transactTypeName" : transactTypeNameValue,
