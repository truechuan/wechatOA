...
//	@Value("#{systemConfigProperties[mailusername]}")
	private  String mailuser;
//	@Value("#{systemConfigProperties[mailuserpassword]}")
	private  String mailpassword;
//	@Value("#{systemConfigProperties[mailsender]}")
	private String personal;
	
	/*
	private String personal="天津市不动产" ;

	private String mailhost="smtp.ym.163.com";
	private String mailuser="customer@xinliandai.com";
	private String mailpassword="xinliandaikf";
*/
...
//			mailMessage.setText(content);
	...
	public static void main(String[] args) {
		...
		mu.sendMail("2494529156@qq.com","PRO", "测试", "这是一封测试邮件");
	}
}
