...
public class ConstantWeChat {
	 ...
	 * 第三方用户唯一凭证
	 */
	public static String APPID = "wx3d29e8f5769f2b5d"; //测试
//	public static String APPID="wx92ffbd45af84ed3b";
//	public static String APPID = "wxc744f029ee477edf"; // 正式
	
	/**
	 * 第三方用户唯一凭证密钥
	 */
	public static String APPSECRET = "869abb6967d50f39b2ccfdfcff7fc2f3";  //测试
//	public static String APPSECRET="004750a59dfcd4b55d9efeca83eda671";
//	public static String APPSECRET = "6e1f1d9835e3f55b1de0065961cc7ac6"; // 正式
